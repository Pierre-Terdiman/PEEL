...
/*
PINT Plugin for Newton 3.12's version released on May 24, 2015.
...
For some reason the library did not compile out of the box: DG_PRUNE_CONTACT_TOLERANCE was undefined.
I found a DG_PRUNE_CONTACT_TOLERANCE___ define in a header that seemed relevant, so I just removed the
underscores to make it compile.

The built-in version number was also wrong, see NewtonPint::GetName().
*/

#include "stdafx.h"
#include "PINT_Newton3_12.h"
...
{ 
	// PT: for some reason the code below returns "Newton 3.13", even though this is using
	// the officially released 3.12 library. So I just hardcode it for now.
	return "Newton 3.12";
