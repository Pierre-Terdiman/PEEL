...
bool HybridModel::Build(const OPCODECREATE& create)
{
	...
	Data.mLeaves = ICE_NEW(AABB)[Data.mNbLeaves];		CHECKALLOC(Data.mLeaves);
	mTriangles = ICE_NEW(LeafTriangles)[Data.mNbLeaves];	CHECKALLOC(mTriangles);
