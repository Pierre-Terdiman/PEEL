...
#ifndef PINT_PHYSX34_H
#define PINT_PHYSX34_H
...
#include "..\PINT_Common\PINT_CommonPhysX3_Vehicles.h"
	...
	class PhysX : public SharedPhysX_Vehicles
	{
		...
		virtual	const char*							GetName()				const	{ return "PhysX 3.4 (PVD - vc11 CL 21578609)";	}
#else
		virtual	const char*							GetName()				const	{ return "PhysX 3.4 (vc11 CL 21578609)";	}
#endif
