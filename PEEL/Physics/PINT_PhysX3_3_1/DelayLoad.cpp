    ...
    switch (dliNotify) {
        ...
        case dliNotePreLoadLibrary :
    		...
    		if( strcmp( pdli->szDll, "PhysX3DEBUG_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3DEBUG_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CommonDEBUG_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CommonDEBUG_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CookingDEBUG_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CookingDEBUG_x86_3_3_1.dll" );

    		if( strcmp( pdli->szDll, "PhysX3CHECKED_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CHECKED_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CommonCHECKED_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CommonCHECKED_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CookingCHECKED_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CookingCHECKED_x86_3_3_1.dll" );

    		if( strcmp( pdli->szDll, "PhysX3PROFILE_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3PROFILE_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CommonPROFILE_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CommonPROFILE_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3CookingPROFILE_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3CookingPROFILE_x86_3_3_1.dll" );

    		if( strcmp( pdli->szDll, "PhysX3_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3Common_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3Common_x86_3_3_1.dll" );
    		if( strcmp( pdli->szDll, "PhysX3Cooking_x86.dll" ) == 0 )
				return (FARPROC)::LoadLibraryA( "PhysX3Cooking_x86_3_3_1.dll" );
			}
            break;
...
//			PxDelayLoadHook::setPhysXCookingInstance(this);
		...
		{
			return "PhysX3CommonDEBUG_x86_3_3_1.dll";
		}

		virtual const char* getPhysXCommonCHECKEDDllName() const
		{
			return "PhysX3CommonCHECKED_x86_3_3_1.dll";
		}

		virtual const char* getPhysXCommonPROFILEDllName() const
		{
			return "PhysX3CommonPROFILE_x86_3_3_1.dll";
		}
