...
//	info.m_allowedPenetrationDepth = 0.0f;
}
...
{
	IceWindow* Main = helper.CreateMainWindow(gHavokGUI, parent, HAVOK_GUI_MAIN, "Havok 2011_3_1 options");
